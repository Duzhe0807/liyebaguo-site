...
const en: Content = {
  ...
  navAbout: "About Us",
  heroEyebrow: "Liyan Baguo | Banquet of Ba Kingdom",
  heroTitleA: "Banquet of Ba Kingdom",
  heroTitleB: "Chongqing Immersive Dinner Show",
  heroBrand: "礼宴巴国",
  heroCopy:
    "A ceremonial evening of palace performance, Ba-Yu cuisine, dynasty costume and live theatre staged around the dining table.",
  ritualOne: "Live Performance",
  ritualTwo: "Regional Cuisine",
  ritualThree: "Traditional Costume",
  ritualFour: "Photo Moments",
  ...
  factDuration: "110-minute immersive show",
  ...
  vipOne: "Private arrangements subject to group size and availability",
