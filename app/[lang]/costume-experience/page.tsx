...
export default async function Page({ params }: { params: Promise<{ lang: Lang }> }) {
  ...
  const page = en ? { title: "Traditional Costume & Portrait Experience", summary: "Add traditional dress to the banquet journey, with styling and photo services confirmed by ticket.", lookbook: "LOOKBOOK", looks: "Four ways to step into the scene", flow: "HOW IT WORKS", flowTitle: "From fitting to photograph", included: "WHAT IS INCLUDED", includedTitle: "What SVIP includes", faqTitle: "Costume questions", faq: [["What does SVIP include?", "SVIP includes traditional costume and traditional headwear."], ["Can I choose a style?", "Choices depend on availability, size and session."], ["When should I arrive?", "The team will provide an arrival time after the costume service is confirmed."]] }
