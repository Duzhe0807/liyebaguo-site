...
export default async function Page({ params }: { params: Promise<{ lang: Lang }> }) {
  ...
  const cancellationGroup = { zh: "退票与取消", tw: "退票與取消", en: "Refunds & cancellation", ja: "払い戻し・中止", ko: "환불 및 취소" }[lang];
  const groups: Group[] = en
    ? [
      ...
      { name: cancellationGroup, items: [[policy.faqQuestion, policy.faqAnswer]] },
    ]
    : [
