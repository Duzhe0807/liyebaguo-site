...
export default async function Page({ params }: { params: Promise<{ lang: Lang }> }) {
  ...
  const copy = {
    ...
    en: { lunch: ["Garden visit", "Welcome ritual", "Banquet & show"], dinner: ["Garden visit", "Welcome ritual", "Banquet & show"], labels: { lunch: "Lunch", dinner: "Dinner", priceNote: "Lunch / Dinner · per guest", bestFor: "Best for", choose: "Choose this seat", meal: "Banquet meal", costume: "Traditional costume", headwear: "Traditional headwear" }, title: "Sessions, Seats & Prices", summary: "Compare lunch and dinner sessions, then choose the seating level that fits your visit.", schedule: "From arrival to the final scene", compare: "Compare what each seat includes", recommended: "Recommended", cancellation: "Cancellation and refund", policy: "Unused bookings may be cancelled. The original booking channel will confirm refund processing and timing.", faqTitle: "Ticket questions", faq: [["Are prices per person?", "Yes. Prices are listed per guest and show lunch / dinner."], ["What does SVIP include?", "In addition to the banquet show, SVIP includes traditional costume and traditional headwear."], ["How do I confirm availability?", "Send a booking request with your date, session and party size."]] },
